...
// Check class exists
if ( ! class_exists( 'HamiltonGravitySlider' ) ) :

    // Create Class HamiltonGravitySlider
    class HamiltonGravitySlider{
         ...
         * @return mixed
         */
        public function add_slider_fields($field_groups){
         ...
         * @return string|void
         */
        public function slider_title_field($type){
            if ( $type == 'slider' ) {
         ...
         * @return string
         */
        public function slider_input( $input, $field, $value, $lead_id, $form_id ){
         ...
         */
        public function slider_gform_editor_js(){
            ?>
            <script type='text/javascript'>
                jQuery(document).ready(function ($) {
         ...
         * Enqueue Script
         */
        public function gform_enqueue_scripts( ){
         ...
         */
        public function set_choice_default_value(){
            ?>
            case "slider" :
